        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">Envio de Correos</h1>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-12">
                                        <div class="signup-form-container">
                                            <form method="POST" action="Enviar-Correo-fijo.php" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-md-7">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="campaña" name="campaña" placeholder="Nombre Campaña"></input>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail2">Mensaje:</label>
                                                            <textarea type="text" class="form-control" id="mensaje" name="mensaje" placeholder="mensaje"></textarea>
                                                        </div>
