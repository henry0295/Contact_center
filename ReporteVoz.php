                    ...
                    <div class="container">
                        ...
                        <div class="card-body">
                            <div class="container mt-5">
                                <div class="row justify-content-center"> <!-- Agregar clase justify-content-center para centrar la fila -->
                                    <div class="col-md-4">
                                        <div class="small-box bg-info text-center"> <!-- Agregar clase text-center para centrar el contenido -->
                                            <div class="inner">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="sendingId" name="sendingId" required>
                                                <?php
                                                // Realizar una consulta a la base de datos para obtener las opciones
                                                // Suponiendo que tienes una conexión a la base de datos llamada $conn
                                                $sql = "SELECT id, name_campaña FROM reportes_voice"; // Reemplaza 'tu_tabla' por el nombre real de tu tabla en la base de datos
                                                $result = $conn->query($sql);

                                                if ($result && $result->num_rows > 0) {
                                                    // Iterar sobre los resultados y generar las etiquetas de opción
                                                    while ($row = $result->fetch_assoc()) {
                                                        echo "<option value='" . $row['id'] . "'>" . $row['name_campaña'] . "</option>";
                                                    }
                                                } else {
                            ...
                            <table id="tuTabla" class="table table-bordered mt-3">
                                ...
                                <tbody>
                                    ...
                                    if ($resultEvents && $resultEvents->num_rows > 0) {
                                        ...
                                        echo "<tr><td colspan='4'>No se consultado resultados.</td></tr>";
                                    }
                                    ?>
